	...
	<section class="container">
		...
		<div class="profile-grid my-1">
			...
			<div class="profile-top bg-primary p-2">
				<img class="round-img my-1" src="img/falljs.jpg" alt="" />
				<h1 class="large">Mouhamadou Moustapha Fall</h1>
				<p class="lead">Developeur à AfroDev-Team</p>
				<p>Seattle, WA</p>
				<div class="icons my-1">
					<a href="#" target="_blank" rel="noopener noreferrer"> <i
						class="fas fa-globe fa-2x"></i>
					</a> <a href="#" target="_blank" rel="noopener noreferrer"> <i
			...
			<div class="profile-github">
				...
				<div class="repo bg-white p-1 my-1">
					<div>
						<h4>
							<a href="#" target="_blank" rel="noopener noreferrer">Repo
								One</a>
						</h4>
