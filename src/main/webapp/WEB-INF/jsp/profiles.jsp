    ...
    <section class="container">
      ...
      <div class="profiles">
        <div class="profile bg-light">
          <img
            class="round-img"
            src="img/falljs.jpg" alt=""/>
          <div>
            <h2>Mouhamadou Moustapha Fall</h2>
            <p>Developeur à AfroDev-Team</p>
            <p>Seattle, WA</p>
        ...
        <div class="profile bg-light">
          <img
            class="round-img"
            src="img/WhatsApp Image 2020-10-15 at 17.55.06.jpeg" alt=""/>
          <div>
            <h2>Ouseynou Job</h2>
